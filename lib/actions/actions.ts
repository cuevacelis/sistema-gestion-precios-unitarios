...
import type { IBodyLogin, IBrowserInfo } from "../types/types";
...
export async function actionsCrearUsuario(_prevState: any, formData: FormData) {
	try {
		...
		const newUrl = `/dashboard/usuarios${url.search}`;
...
export async function actionsCrearCliente(_prevState: any, formData: FormData) {
	try {
		...
		const returnUrl =
			url.searchParams.get("returnUrl") || "/dashboard/clientes";
		const newUrl = returnUrl + url.search;
...
export async function actionsEditarCliente(
	...
	try {
		...
		const returnUrl =
			url.searchParams.get("returnUrl") || "/dashboard/clientes";
		const newUrl = `/dashboard/clientes${url.search}`;
...
export async function actionsCrearPresupuesto(
	...
	try {
		...
		const returnUrl =
			url.searchParams.get("returnUrl") || "/dashboard/clientes";
		const newUrl = `/dashboard/proyectos${url.search}`;
...
export async function actionsCrearGrupoPartida(
	...
	try {
		...
		const returnUrl =
			url.searchParams.get("returnUrl") || "/dashboard/clientes";
		const newUrl = replaceSegmentInPath(
...
export async function actionsDeleteGrupoPartida(
	...
	try {
		...
		const returnUrl =
			url.searchParams.get("returnUrl") || "/dashboard/clientes";
		const newUrl = `/dashboard/grupos_de_partida${url.search}`;
...
export async function actionsCrearPartida(_prevState: any, formData: FormData) {
	try {
		...
		const returnUrl =
			url.searchParams.get("returnUrl") || "/dashboard/clientes";
		const newUrl = `/dashboard/partidas${url.search}`;
...
export async function actionsCrearRecurso(_prevState: any, formData: FormData) {
	try {
		...
		const returnUrl =
			url.searchParams.get("returnUrl") || "/dashboard/clientes";
		const newUrl = `/dashboard/recursos${url.search}`;
